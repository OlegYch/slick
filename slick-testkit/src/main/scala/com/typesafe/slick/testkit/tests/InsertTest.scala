...
class InsertTest extends AsyncTest[JdbcTestDB] {
  ...
  def testInsertOrUpdatePlainWithFuncDefinedPK: SlickAction[NoStream, Effect.All, Unit] = {
  ...
  def testInsertOrUpdateWithInsertedWhen0IsSpecifiedForAutoInc: SlickAction[NoStream, Effect.All, Unit] =
  ...
  def testInsertOrUpdateAutoInc: SlickAction[NoStream, Effect.All, Unit] = {
  ...
  def testInsertOrUpdateWithPrimaryKeyOnly: SlickAction[NoStream, Effect.All, Unit] =
  ...
  def testInsertOrUpdateWithIntegrityError: SlickAction[NoStream, Effect.All, Unit] = {
