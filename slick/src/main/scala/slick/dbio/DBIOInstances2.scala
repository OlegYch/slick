...
//
//trait DBIOInstances2 {
//  implicit def dbioInstance: MonadError[[R] =>> DBIOAction[NoStream, Effect, R], Throwable] =
...
//    }
//
//  implicit def dbioGroup[A: Group]: Group[DBIOAction[NoStream, Effect, A]] =
//    new DBIOGroup[A]
//
//  implicit def dbioMonoid[A: Monoid]: Monoid[DBIOAction[NoStream, Effect, A]] =
//    new DBIOMonoid[A]
//
//  implicit def dbioSemigroup[A: Semigroup]: Semigroup[DBIOAction[NoStream, Effect, A]] =
//    new DBIOSemigroup[A]
//
