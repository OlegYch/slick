...
/** A phantom type used as the streaming result type for SlickActions that do not support streaming.
...
/** A phantom type used as the streaming result type for SlickActions that do support streaming. */
